<template>
  <div class="home">
    <v-card  class="black" style="position:relative;">
        ...
        >
          <v-container >
            <v-layout row>
              ...
              <v-flex xs6 md8  > 
                <div class="ma-9 " >
                    <v-img width="30%" src="https://www.rotary.org/sites/all/themes/rotary_rotaryorg/images/rotary-logo-white-2019-simplified.svg">
                  </v-img>
                  </div>
                  <div  class=" yellow--text ma-6">                  
