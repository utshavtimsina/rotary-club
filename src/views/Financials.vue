  ...
  <div>
      <v-card flat  class="structure" >
          <v-container style="text-align: center;vertical-align: middle;">
              <v-layout column  > 
                  <p class="display-3 my-8 white--text text-center" >
                     Our Finances
                  </p>
        ...
        <div class="images">
            <v-container  >
                <div style="position:relative;">
                    <img width="100%" height="100%"  src="https://www.rotary.org/sites/default/files/styles/w_864/public/Donate-hero-w2800x975-1.jpg?itok=w1PJ1Xc- 864w, https://www.rotary.org/sites/default/files/styles/w_1080/public/Donate-hero-w2800x975-1.jpg?itok=qs_bqzWI 1080w, https://www.rotary.org/sites/default/files/styles/w_1400/public/Donate-hero-w2800x975-1.jpg?itok=A6ox9TEt 1400w, https://www.rotary.org/sites/default/files/styles/w_1728/public/Donate-hero-w2800x975-1.jpg?itok=LRiMaymq 1728w, https://www.rotary.org/sites/default/files/styles/w_2160/public/Donate-hero-w2800x975-1.jpg?itok=2WPKPHiY 2160w, https://www.rotary.org/sites/default/files/styles/w_2800/public/Donate-hero-w2800x975-1.jpg?itok=PDJdtKJ9 2800w" alt="">
                    <v-btn width="10%" height="4%"  class="pink" dark style="padding :2% 5%; position:absolute; bottom:60%;right:10%;">
                        Donate
                    </v-btn>
                </div>
            </v-container>
